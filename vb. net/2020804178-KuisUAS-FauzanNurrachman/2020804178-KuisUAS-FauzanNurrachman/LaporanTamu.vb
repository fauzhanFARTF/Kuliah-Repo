...
Public Class LaporanTamu
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_2020804178_KuisUAS_FauzanNurrachman.LaporanTamu.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanTamu
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanTamu = New LaporanTamu()
        rpt.Site = Me.Site
        Return rpt
    End Function
