...
Public Class DataCustomer
    ...
    Sub Tampilgrid()
        ...
        DataGridView1.DataSource = ds.Tables("tbcustomer")
    ...
    Private Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        ...
        Else
            Call koneksi()
            Try
                Dim simpan As String = "insert into tbcustomer (kdcustomer, namacustomer, tlp , email , alamat) values ('" & TextBox1.Text & "', '" & TextBox2.Text & "', '" & TextBox3.Text & "','" & TextBox4.Text & "','" & RichTextBox1.Text & "')"
    ...
    Private Sub textbox1_LostFocus(sender As Object, e As EventArgs) Handles TextBox1.LostFocus
        str = "SELECT * FROM tbcustomer where kdcustomer ='" & TextBox1.Text & "'"
        ...
        Try
            While rd.Read
                ...
                RichTextBox1.Text = rd.GetValue(4)
                Textmati()
                Me.btnadd.Enabled = False
                Me.btnsave.Enabled = False
    ...
    Private Sub btnupdate_Click(sender As Object, e As EventArgs) Handles btnupdate.Click
        If MessageBox.Show("Do You Want Save Again ?", "SUKSES", MessageBoxButtons.YesNo, MessageBoxIcon.Information) = vbYes Then
            sql = "update tbcustomer set namacustomer = '" & TextBox2.Text & "', tlp = '" & TextBox3.Text & "', email ='" & TextBox4.Text & "', alamat = '" & RichTextBox1.Text & "' where kdcustomer = '" & TextBox1.Text & "'"
    ...
    Private Sub btndelete_Click(sender As Object, e As EventArgs) Handles btndelete.Click
        ...
        Else
            If MessageBox.Show("Yakin akan dihapus..?", "", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
                Dim hapus As String = "Delete * from tbcustomer where kdcustomer='" & TextBox1.Text & "'"
    ...
    Private Sub TextBox4_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox3.KeyPress
        ...
        If e.KeyChar = Chr(13) Then RichTextBox1.Focus()
    End Sub
    Private Sub RichTextbox_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox4.KeyPress
    ...
    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        ...
        RichTextBox1.Text = DataGridView1.Rows(i).Cells(4).Value.ToString()
        Call Textmati()
        Me.btnadd.Enabled = False
        Me.btnsave.Enabled = False
        Me.btnedit.Enabled = True
